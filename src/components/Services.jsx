          ...
          <div className="relative z-1 flex items-center h-[39rem] mb-5 p-8 border-n-1/10 rounded-3xl overflow-hidden lg:p-20 xl:h-[46rem]">
            ...
            <div className="relative z-1 max-w-[17rem] ml-auto">
              ...
              <p className="body-2 mb-[3rem] text-n-3">
                Brainwave unlockes the potential of AI-powered applications
              </p>
              <ul className="body-2 ">
            ...
            <Generating className="absolute left-4 right-4 bottom-4 border border-n-1/10 md:left-1/2 md:right-auto md:bottom-8 md:w-[31rem] lg:left-1/2 lg:right-auto lg:bottom-8 lg:-translate-x-1/2 md:-translate-x-1/2" />
          </div>
